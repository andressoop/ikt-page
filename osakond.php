<?php require_once('couch/cms.php'); ?>
    ...
    <cms:template title='Osakonna tutvustus' order="2">
        <cms:editable name='osakond_tutvustus_title_ee' label="(EST) Osakonna tutvustuse lehe pealkiri" order="1" type='text' />
        <cms:editable name='osakond_tutvustus_title_en' label="(ENG) Osakonna tutvustuse lehe pealkiri" order="2" type='text' />
